...
>>>>>>> 2079565a2fd9e2e5534bbbc12658c683e82ffa6c
          ...
          {converstation && (
            <div className="p-14 w-full flex items-center">
              <input
                ...
                className="w-[90%] h-[50px] p-3 border border-gray-300 rounded-xl focus:outline-none focus:border-gray-500"
              />
              <div
                className="cursor-pointer ml-6"
                onClick={() => setEmoji((prev) => !prev)}
              >
                <BsEmojiSmile className="h-[35px] w-[35px]" />
              </div>
              <div className="cursor-pointer ml-6">
                <FiSend className="h-[35px] w-[35px]" />
              </div>
            </div>
          )}
          {showEmoji && (
            <div className="absolute bottom-24 right-14 z-20">
              <Picker
                data={data}
        ...
        <div className="hidden lg:block w-[25%] h-screen bg-[#c7a8b2]">
          <img src={logo} alt="chat logo" className="w-[60%] mx-auto mt-24" />
        </div>
      </div>
    </>
  );
