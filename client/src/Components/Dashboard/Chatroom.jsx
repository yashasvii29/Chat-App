...
//                 <div className="text-gray-600 h-4 w-4 text-sm">Typing...</div>
//               )}
//             </div>
//           </div>
//           {converstation && (
        ...
        <div className="w-full md:w-[50%] h-screen bg-white flex flex-col items-center">
          ...
          <div className="h-[75%] w-full overflow-y-scroll shadow-sm border-b">
            <div className="p-14">
             ...
             {console.log('Typing:', typing, 'Sender ID:', typingSenderId)}
             {console.log(typingSenderId === receiverData?.id)}
             {typing && typingSenderId === receiverData?.id && (
