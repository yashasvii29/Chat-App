...
//                 onKeyDown={sendMessageHandler}
//                 onChange={(e) => setMessage(e.target.value)}
//                 className="border w-full border-gray-300 p-3 rounded-full text-lg font-light"
...
//           )}
//         </div>
//         <div className="hidden md:block md:w-[25%] h-screen bg-[#e5d8d8] flex flex-col items-center py-16">
//           <img src={logo} className="w-[60%] mb-10" />
//           <p className="text-center text-lg font-light text-gray-600 mx-10">
//             Welcome to our chat application. Please select a conversation to start chatting.
//           </p>
//         </div>
//       </div>
//     </>
